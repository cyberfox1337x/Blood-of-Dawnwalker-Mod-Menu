...
function Driver.validate_attestation(text, boot_id, now)
    ...
    require_condition(count == 10 and fields.schema == "6" and OPERATIONS[fields.operation] == fields.intent, "attestation schema or intent is invalid")
...
function Driver.install(deps)
    ...
    local function cleanup_dependencies(fields)
        ...
        local function report(receipt)
            ...
            local envelope = { schema = 6, operation = fields.operation, boot_id = boot_id, nonce = fields.nonce,
