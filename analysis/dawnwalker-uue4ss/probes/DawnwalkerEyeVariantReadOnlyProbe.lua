...
function Probe.run(deps)
    local ok, result = pcall(function()
        ...
        check(deps.identity.build_id == "25129649" and deps.identity.executable_sha256 == "7AD7D09645B0589DC0FF78B53AA1A7B18ECA79B1B7F888B403AB41D88AC7E853", "Reviewed native identity differs")
