...
local function attestation(overrides)
    local fields = {
        schema = "7", operation = "observe", intent = "eye-observe", build_id = "25129649",
...
test("schema seven is required and queued operation cannot change", function()
    for _, schema in ipairs({ "2", "3", "4", "5", "6" }) do
