...
cyberfox1337x.function_signature("dawnwalker_private_eye_renderer_tests")
...
local function fixture()
    ...
    function actor:AddComponentByClass(class)
        ...
        function component:GetNumMaterials() return self.asset.material_count or 1 end
...
print("Passed " .. count .. " private renderer groups")
